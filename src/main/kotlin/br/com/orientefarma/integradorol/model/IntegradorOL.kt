...
class IntegradorOL(val pedidoOL: PedidoOL) {
    ...
    init {
        ...
        } ?: throw IllegalStateException("Verifique o par�metro $nomeParamTOPPedido.")
    ...
    private fun verificarRegrasComerciais(mensagem: String, pedidoCentralVO: CabecalhoNotaVO): Boolean {
        ...
        if (ehDocumentoFaltante) {
            ...
            for (matchResult in regexProdutosComDocsFaltantes.findAll(mensagem)) {
                ...
                itemPedidoOL?.setFeedback("Falta de documenta��o", 0)
    ...
    /**
     * Marcar o item como N�O pendente na central, bem como adiciona uma mensagem no campo observa��o.
     */
    ...
    /**
     * Marcar TODOS os itens do PRODUTO como N�O pendente na central, bem como adiciona uma mensagem no campo observa��o.
    ...
    /**
     * Marcar TODOS os itens do PEDIDO como N�O pendente na central, bem como adiciona uma mensagem no campo observa��o.
     * Lembrando que este processo precisa ser feito item a item - trigger de estoque Sankhya.
     */
    ...
    /**
     * Cria o item na central de vendas, validando as seguintes regras: campos b�sicos, valida estoque, valida desconto
    ...
    private fun getProdutoVO(codProd: Int?): ProdutoVO {
        if(codProd == null)
            throw EnviarItemPedidoCentralException("Produto n�o informado.")
    ...
    private fun buscarCliente(pedidoOLVO: PedidoOLVO): ParceiroVO {
        ...
        if (clienteVO == null){
            val mensagem = "Cliente n�o cadastrado com o CNPJ ${pedidoOLVO.cnpjCli}"
    ...
    /**
     * Chama a rotina de confirma��o nativa da central, caso exista item pendente no pedido.
     */
    @Throws(Exception::class)
